...
let resutadosGastos
let resultadosAhorros
let guardarIngresos
let guardarGastos
const ahorrosContador = document.querySelector('#contador-ahorros') 
const ingresosContador = document.querySelector('#contador-ingresos') 
const gastosContadpr = document.querySelector('#contador-gastos') 
...
form.addEventListener("submit", function(event) {
    ...
    saveTransactiobObj(transactionObj)
...
function convertFormDataToTransactionObj(transactionFormData) {
    ...
    sumIngresosGastos(transactionAmount);
}
...
function saveTransactiobObj(transactionObj) {
